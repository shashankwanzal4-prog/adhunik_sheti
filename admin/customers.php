...
$customers = [];
$result = $db->query("SELECT DISTINCT customer_name, customer_email, customer_phone, customer_address, COUNT(*) as total_orders, SUM(total_amount) as total_spent FROM orders GROUP BY customer_name, customer_email, customer_phone, customer_address ORDER BY created_at DESC");
...
<body>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <button class="btn btn-outline-primary" onclick="viewCustomerOrders('<?php echo htmlspecialchars($customer['customer_name']); ?>')">
    ...
    <script>
        function viewCustomerOrders(customerName) {
            alert('View orders for: ' + customerName + '\n\nThis would typically open a detailed view of all orders for this customer.');
        }
    </script>
</body>
</html>
